# manual fix for https://github.com/fog/fog-aws/pull/593 line 294 patched
module Fog
  module Storage
        ...
        def request_params(params)
          ...
          if params[:bucket_name]
            ...
            if params[:bucket_cname]
              ...
              elsif host.start_with?("#{bucket_name}.")  # backport of https://github.com/fog/fog-aws/pull/593
                # no op
              else
